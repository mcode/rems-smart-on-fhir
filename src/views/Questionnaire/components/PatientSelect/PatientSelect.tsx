    ...
    <div>
      <div className="patient-header">
        ...
        <Dialog
          ...
          classes={{ paper: 'info-padding' }}
          open={open}
        >
          <div>Info</div>
          <hr />
          <div>
            The standalone launch for DTR skips the CRD workflow and provides access to the EHR
            without a selected questionnaire or patient. Patients with in-progress questionnaires
