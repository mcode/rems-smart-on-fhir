import { DeviceRequest, Extension, FhirResource, MedicationRequest, Questionnaire, QuestionnaireItem, QuestionnaireResponse, QuestionnaireResponseItem, ServiceRequest } from "fhir/r4";
interface MyObject {
    [key: string]: any;
}
...
export function searchQuestionnaire(questionnaire: QuestionnaireResponseItem, attestation: string[]) {
...
export function buildNextQuestionRequest(questionnaire: Questionnaire, questionnaireResponse: QuestionnaireResponse) {
